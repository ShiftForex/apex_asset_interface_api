...
class websocketService {
    constructor(options){
        ...
        this.websocketClient.onopen = () => {
            ...
            this.authenticate({ UserName: this.options.AMUserName, Password: this.options.AMUserPassword, AssetManagerId : this.options.AssetManagerID })
    ...
    async authenticate(req) {
        try{
            this.logger.log('inside authenticate method....')
            ...
            // this.websocketConnection.send(frameJSON)
