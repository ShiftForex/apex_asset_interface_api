...
client.onmessage = function (e) {
	...
	if (typeof e === 'string' && e === "pong") {
        log.info("Received string: '" + e + "'");
		resolve("connected");
    }
...
function wsHeartBeat(){
    ...
    hearBeat.then(
        function(successMessage){
            log.info("The WebSocket connection to Asset Manager is " + successMessage);
            setTimeout(wsHeartBeat, config.TimeInterval);
        }
    );
    ...
    hearBeat.catch(
        function(reason){
            log.info("The WebSocket connection to Asset Manager is " + reason);
            amconnected = false;
            setTimeout(wsHeartBeat, config.TimeInterval);
        }
    );
